export default function Homesection() {
  ...
  return (
    <div className=" py-4 sm:py-8 lg:py-12 overflow-hidden relative">
      {/* SECTION - 1 */}
      <section className="relative max-w-6xl mx-auto p-5">
        <div
          className="
        relative overflow-hidden shadow-lg mt-2 sm:mt-4 lg:mt-6
        rounded-2xl sm:rounded-[36px] bg-[#E4E9ED]
      "
          style={{
            boxShadow:
              "0 6px 28px rgba(0,84,231,0.15), 0 -2px 6px rgba(0,84,231,0.08)",
          }}
        >
          <div className="flex flex-col lg:flex-row items-center text-center lg:text-left px-6 lg:px-14 py-10 lg:py-20">
            {/* Left Side Image */}
            <figure className="flex-1 flex justify-center lg:justify-start order-1 mb-8 lg:mb-0">
              <div className="relative w-[280px] sm:w-[360px] lg:w-[480px] aspect-square">
                <img
            ...
            {/* Right Side Text */}
            <article className="flex-1 lg:max-w-[58%] order-2">
              {/* Logo */}
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-snug mb-4">
                ...
                <span className="text-[#0000aa]">First Non-Expiry</span>{" "}
                <span className="text-gray-800">Water</span>
              </h1>

              {/* Description */}
              <p className="text-gray-700 text-sm sm:text-base lg:text-lg mb-6 leading-relaxed max-w-xl mx-auto lg:mx-0">
                Empire Blue Pvt. Ltd. prioritizes health, innovation, and
                sustainability. We are committed to setting new standards and
                providing a safe, reliable, and beneficial hydration solution for
                people worldwide.
              </p>
              ...
              <div className="flex justify-center lg:justify-start">
                ...
                bg-[#0000aa] hover:bg-blue-800 transition-colors shadow-md
              "
                >
                  Contact Us
                  <svg
          ...
          {/* Decorative SVG */}
          <div className="relative w-full -mt-10 sm:-mt-24 pointer-events-none">
            <svg
              className="w-full h-[120px] sm:h-[180px] lg:h-[220px]"
